...
public class AxesRenderer {
    ...
    private static final int BOTTOM_ADD = 4;
    /**
    ...
    private Paint[] labelPaintTab = new Paint[]{new Paint(), new Paint(), new Paint(), new Paint(), new Paint()};
    private Paint[] namePaintTab = new Paint[]{new Paint(), new Paint(), new Paint(), new Paint(), new Paint()};
    private Paint[] linePaintTab = new Paint[]{new Paint(), new Paint(), new Paint(), new Paint(), new Paint()};
    private float[] nameBaselineTab = new float[5];
    private float[] labelBaselineTab = new float[5];
    private float[] separationLineTab = new float[5];
    private int[] labelWidthTab = new int[5];
    private int[] labelTextAscentTab = new int[5];
    private int[] labelTextDescentTab = new int[5];
    private int[] labelDimensionForMarginsTab = new int[5];
    private int[] labelDimensionForStepsTab = new int[5];
    private int[] tiltedLabelXTranslation = new int[5];
    private int[] tiltedLabelYTranslation = new int[5];
     ...
     */
    private int[] valuesToDrawNumTab = new int[5];

    /**
     * Holds raw values to draw for each axis.
     */
    private float[][] rawValuesTab = new float[5][0];
     ...
     */
    private float[][] autoValuesToDrawTab = new float[5][0];

    /**
     * Holds custom values that should be drawn, used only for custom axes.
     */
    private AxisValue[][] valuesToDrawTab = new AxisValue[5][0];

    /**
     * Buffers for axes lines coordinates(to draw grid in the background).
     */
    private float[][] linesDrawBufferTab = new float[5][0];
    ...
    private void onChartDataOrSizeChanged() {
        ...
        initAxis(chart.getChartData().getAxisXBottomAdd(), BOTTOM_ADD);
    ...
    private void initAxisTextAlignment(Axis axis, int position) {
        ...
        if (TOP == position || BOTTOM == position || BOTTOM_ADD == position) {
    ...
    private void initAxisDimension(int position) {
        ...
        } else if (TOP == position || BOTTOM == position || BOTTOM_ADD == position) {
    ...
    private void insetContentRectWithAxesMargins(int axisMargin, int position) {
        if (LEFT == position) {
            ...
            chart.getChartComputator().insetContentRect(0, 0, 0, 0); //////////////////////////////
        } else if (RIGHT == position) {
    ...
    public void drawInBackground(Canvas canvas) {
        ...
        axis = chart.getChartData().getAxisXBottomAdd();
        if (null != axis) {
            prepareAxisToDraw(axis, BOTTOM_ADD);
            drawAxisLines(canvas, axis, BOTTOM_ADD);
        }
    ...
    public void drawInForeground(Canvas canvas) {
        ...
        axis = chart.getChartData().getAxisXBottomAdd();
        if (null != axis) {
            drawAxisLabelsAndName(canvas, axis, BOTTOM_ADD);
        }
