...
public abstract class AbstractChartData implements ChartData {
    ...
    public AbstractChartData(AbstractChartData data) {
        ...
        if (null != data.axisXBottomAdd) {
            this.axisXBottomAdd = new Axis(data.axisXBottomAdd);
        }
    ...
    @Override
    public Axis getAxisXBottomAdd() {
        return axisXBottomAdd;
    }

    @Override
    public void setAxisXBottomAdd(Axis axisX) {
        this.axisXBottomAdd = axisX;
    }
