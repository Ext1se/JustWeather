...
public class Line {
    ...
    public Line(List<PointValue> values, List<Bitmap> images) {
        setValues(values);
        setImages(images);
    }
    ...
    public Line(Line line) {
        ...
        this.hasDescription = line.hasDescription;
        ...
        this.labelBackgroundColor = line.labelBackgroundColor;
        this.labelTextColor = line.labelTextColor;
        ...
        for (String description : line.descriptions) {
            this.descriptions.add(new String(description));
        }
    }
    ...
    public Line setHasDescription(boolean hasDescription) {
