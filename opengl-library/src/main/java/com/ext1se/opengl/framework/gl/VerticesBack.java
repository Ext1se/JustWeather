...
public class VerticesBack {
    ...
    public VerticesBack(GLGraphics glGraphics, int maxVertices, int maxIndices, boolean hasColor, boolean hasTexCoords) {
    ...
    public void bind() {
        ...
        if(hasTexCoords) {
            ...
            vertices.position(hasColor?6:3);
    ...
    public void draw() {
        ...
        //gl.glDrawElements(GL10.GL_TRIANGLES, 12, GL10.GL_UNSIGNED_SHORT, indices);
